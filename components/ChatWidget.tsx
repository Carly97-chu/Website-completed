...
const ChatWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end pointer-events-none">
      {/* Chat Window - Only pointer-events-auto when visible */}
      <div
        className={`mb-4 w-[calc(100vw-3rem)] md:w-96 bg-[#0f1115]/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 origin-bottom-right ${
      ...
      {/* Toggle Button - Explicitly pointer-events-auto */}
      <button
        onClick={() => setIsOpen(!isOpen)}
        className={`group relative flex items-center justify-center w-14 h-14 rounded-full shadow-2xl transition-all duration-500 hover:scale-110 pointer-events-auto ${
