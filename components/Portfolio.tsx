...
const AICustomerCareCaseStudy: React.FC<{ onClose: () => void }> = ({ onClose }) => (
  <div className="max-w-6xl w-full mx-auto text-center px-4 md:px-0 relative">
    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-4">
      <button className="bg-white text-black px-8 py-4 rounded-xl font-bold inline-flex items-center gap-3 hover:bg-slate-200 transition-colors shadow-xl"><Github className="w-5 h-5" /> VIEW PROJECT ON GITHUB <ExternalLink className="w-4 h-4 opacity-50" /></button>
  ...
  <div className="max-w-7xl w-full mx-auto animate-fade-in-up pb-24 px-4 md:px-12">
    <div className="text-center mb-24">
      ...
      <div className="flex flex-col items-center gap-6">
        <button className="px-10 py-4 bg-white text-black rounded-xl font-black tracking-tight hover:bg-slate-200 transition-all uppercase text-sm flex items-center gap-3"><Github className="w-5 h-5" /> VIEW PROJECT ON GITHUB <ExternalLink className="w-4 h-4 opacity-50" /></button>
...
const CulinaryPlatformCaseStudy: React.FC<{ onClose: () => void }> = ({ onClose }) => (
  <div className="max-w-7xl w-full mx-auto animate-fade-in-up pb-24 px-4 md:px-12">
    <div className="text-center mb-24">
      ...
      <button className="px-10 py-4 bg-white text-black rounded-full font-bold tracking-tight hover:bg-slate-200 transition-all uppercase text-sm mb-32">VIEW FULL PROJECT</button>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-7xl mx-auto mb-32">
        ...
        <div className="bg-[#111111] border border-white/5 rounded-[2rem] p-10 flex flex-col justify-between h-full group">
          <div><span className="text-[10px] uppercase tracking-widest text-indigo-400 font-bold mb-8 block">TRENDS</span><h3 className="text-2xl font-bold text-white mb-6">The "Pro" Shift</h3><p className="text-slate-500 text-base font-light mb-12 leading-relaxed">Data shows users seek challenges: Intermediate/Advanced recipes score highest, ending the "basic" content era.</p></div>
       ...
       <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-6xl mx-auto">
          <div className="lg:col-span-5 space-y-10 text-left">
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div><h4 className="text-xl font-bold text-white mb-2">Trend Visualization</h4><p className="text-slate-500 font-light leading-relaxed">Mapping the journey from the vineyard to the global final market.</p></div>
            </div>
          </div>
...
const NetflixContentCaseStudy: React.FC<{ onClose: () => void }> = ({ onClose }) => (
  <div className="max-w-7xl w-full mx-auto animate-fade-in-up pb-24 px-4 md:px-12">
    <div className="text-center mb-24">
      ...
      <button className="px-10 py-4 bg-indigo-500/30 border border-indigo-500/50 text-indigo-200 rounded-full font-bold tracking-tight hover:bg-indigo-500/40 transition-all uppercase text-sm mb-24">
        VIEW FULL PROJECT
      </button>
